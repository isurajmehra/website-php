...
<title>Google Home Services|Acropolis Infotech</title>
    ...
    <div class="scrolling-list-component">
        <div class="scrolling-button-container">
                ...
                <span class="dot-circle three"></span></div>
                    <div class="scrolling-list-container" style="top:-90%">
...
<div class="row hero-banner scrolling-section" style="background-image:url(../assets/img/banner/ai.jpg);">
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class=" clanpro-bold fz-70 color-white pd-0-55">Google Home Services</h3>
    ...
    <div class="hero-banner-box">
        ...
        <ul class="list list-inline hero-banner-box-list">
            ...
            <div class="hero-banner-box-button-container">
                <a href="alexa-app-development.html" class="hero-banner-box-arrow-button left active"><i class="fa fa-angle-left"></i></a>
                <a class="hero-banner-box-arrow-button right active" href="nlp.html"><i class="fa fa-angle-right"></i></a>
        </div>
    </div>
...
<div class="row service-overview pd-60-0 relative page-section scrolling-section" id="overview">
    <div class="background-title">
        <h3 class=web-services>Google Home</h3>
        
    </div>
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center fz-48 clanpro-bold">Google Home Features</h1>
    </div>
...
<div class="row services-sample page-section scrolling-section" id="our-capabilities">
     <div class="col-md-4 service-sample-link relative bg-green pd-30-0 pdl-10" style="min-height:586px;">
        ...
        <ul class="list service-sample-list clanpro color-white fz-18">
            <li class=" active pd-10-0">Google Action SDK</li>
            <li class="pd-10-0">Dialogflow</li>
       </ul>
     ...
     <div class="col-md-4 service-sample-description pd-0-0 bg-gray relative" style="min-height:586px">
        <div class="col-md-12 relative">
         <a href="#" class="service-title pdb-30 fz-48 clanpro-bold">Smart Home</a>
...
<div class="row domain-expertise pd-90-0 page-section scrolling-section" id="key-areas">
    <div class="col-md-12 pd-0-0 domain-expertise-heading relative">
    <h1 class="section-title align-center pd-30-0 clanpro-bold fz-48">Key Areas</h1>
    </div>
...
<script type="text/javascript">
    ...
    responsive:{
        ...
        var service_title=["Smart Home","Google Actions SDK","Dialogflow"];
