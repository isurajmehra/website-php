...
<meta property="og:title" content="Web Application Development Company USA, India | Web Design & Development Services">
<meta property="og:description" content="Top web application development company across the globe - Acropolis offers custom web application development services at most affordable rates. Get Free Quote Now!">
...
<title>Web Application Development Company USA, India | Web Design & Development Services</title>
<meta name="description" content="Top web application development company across the globe - Acropolis offers custom web application development services at most affordable rates. Get Free Quote Now!">
...
<div class="row hero-banner scrolling-section">
    <picture>
            <source  srcset="assets/img/banner/webp/web-development.webp" alt="webp">
            <source  srcset="assets/img/banner/jp2/web-development.jp2" alt="jp2">
            <img src="assets/img/banner/web-development.jpg" alt="jpg">
        </picture>
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class=" clanpro-bold fz-70 lh-80 color-white pd-0-55">Web Application Development Company</h3>
...
Acropolis helps you to build from very small websites to large scale Ecommerce websites. Acropolis helps you to build your website from a scratch, be it a small basic website or a large Ecommerce website.</p>
            </div>
        </div>
    </div>
...
<!-- opening of overview section -->

<div class="row service-overview pd-60-0 relative page-section scrolling-section" id="overview">
    <div class="background-title">
        <h3 class=web-services>Web Services</h3>
        
    </div>
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center clanpro-bold fz-48">Custom Web Application Development Services</h1>
    </div>
    <div class="col-md-6 service-overview-stats pd-60">
        <p class="pd-0-60 color-light-green clanpro fz-21 lh-36">Acropolis InfoTech is an IT consulting and service providing company that also provides custom web development services. They guarantee good quality, responsive and user friendly websites and applications.</p>
        
    </div>
    <div class="col-md-6 service-overview-description pd-60">
        <p class="pd-0-60 clanpro fz-21 lh-36">Acropolis provides platform and also builds high quality web applications. It has a reputation of developing large and complex projects. Acropolis guarantees long term solutions using latest technologies.</p>
        
    </div>
    <div class="col-md-12 pd-30-0">
        <p class="pd-0-60 clanpro fz-21 lh-36">Why should you choose Acropolis for Web Application Development?</p>
        <ul class="acropolis-point-list pdt-30 pdl-60">
            <li class="clanpro fz-20 color-green">A highly skilled and experienced team.</li>
            <li class="clanpro fz-20 color-green">Delivered websites and web applications across the globe.</li>
            <li class="clanpro fz-20 color-green">Use latest technologies.</li>
            <li class="clanpro fz-20 color-green">Fulfils customer's requirement.</li>
            <li class="clanpro fz-20 color-green">Provides customer security and reliability.</li>
            <li class="clanpro fz-20 color-green">Budget Friendly.</li>
        </ul>
