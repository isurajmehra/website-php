...
<meta property="og:title" content="Enterprise Internet of Things, IoT Solutions Company USA, India | IoT Application Development Services">
<meta property="og:description" content="We are Internet of Things solutions Company with proven experience in delivering high end IoT solutions. Our proficiency includes IoT Applications, IoT Security, IoT Platforms, Data Management & Service Innovation. Contact us for IoT application development services.">
...
<title>Enterprise Internet of Things, IoT Solutions Company USA, India | IoT Application Development Services</title>
 <meta name="description" content="We are Internet of Things solutions Company with proven experience in delivering high end IoT solutions. Our proficiency includes IoT Applications, IoT Security, IoT Platforms, Data Management & Service Innovation. Contact us for IoT application development services." />
...
<div class="row hero-banner scrolling-section">
    <picture>
        <source  srcset="assets/img/banner/webp/iot.webp" alt="webp">
            <source  srcset="assets/img/banner/jp2/iot.jp2" alt="jp2">
            <img src="assets/img/banner/iot.jpg" alt="jpg">
        </picture>
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class=" clanpro-bold fz-70 lh-80 color-white pd-0-55">Internet of Things (IoT)<br>Solutions</h3>
...
<div class="row service-overview pd-60-0 relative page-section scrolling-section" id="overview">
    <div class="background-title">
        <h3 class="web-services" style="padding:16% 0%;">IoT Solutions</h3>
        
    </div>
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center fz-48 clanpro-bold">Unleash Innovation with IoT Application Development</h1>
    </div>
    <div class="col-md-6 service-overview-stats pd-60">
        <p class="pd-0-60 color-light-green fz-21 lh-36 clanpro">Acropolis provides you a safe investment plan to automate your business process, secure important data, improve decision making and cut down any unnecessary expense. Acropolis is ready to unleash the potentials of this powerful technology that will redefine the way we interact with other humans, machines, and devices.</p>
        
    </div>
    <div class="col-md-6 service-overview-description pd-60">
        <p class="pd-0-60 fz-21 lh-36 clanpro">IOT has been creating waves that no business in the world can deny or resist. IOT has made its mark in every field and has been improving lives of people across the globe.</p>
        
    </div>
    <div class="col-md-12 pd-30-0">
        <p class="pd-0-60 fz-21 lh-36 clanpro">Acropolis offers technologically advanced Internet of Things application, allowing your business to maximize benefits. Acropolis delivers enterprise and Internet of Things applications to support smart initiatives from the diverse industries ranging from the security, to the home automation, to industrial IOT that can transform business operations and improve lives.
        </p>
...
<div class="row iot-services-sample pd-100-0 pdb-0 page-section scrolling-section" id="services">
            <h3 class="section-heading clanpro-bold align-center center pdb-60 fz-45 color-green">Internet of Things Services</h3>
    <div class="col-md-4 iot-sample">
        <img src="assets/img/iot-sample/meeting.jpg" alt="Iot Service">
        <div class="iot-sample-description">
            <p class="clanpro-bold fz-30 color-white">Advisory<br> Service</p>
        </div>
        
    </div>
    <div class="col-md-4 iot-sample">
                <img src="assets/img/iot-sample/implementation.jpg" alt="Implementation">
                        <div class="iot-sample-description">
            <p class="clanpro-bold fz-30 color-white">Implementation<br> Service</p>
        </div>
        
    </div>
    <div class="col-md-4 iot-sample">
                <img src="assets/img/iot-sample/maintainance.jpg" alt="Iot Service">
                        <div class="iot-sample-description">
            <p class="clanpro-bold fz-30 color-white">Maintainanace<br> Service</p>
        </div>
