...
<meta property="og:title" content="Blockchain Development Company | Blockchain Development Solutions & Services">
<meta property="og:description" content="Acropolis offers blockchain technology to accelerate your business. We build innovative blockchain development solutions to build innovative applications. Contact us for best blockchain development services.">
...
<title>Blockchain Development Company | Blockchain Development Solutions & Services</title>
<meta name="description" content="Acropolis offers blockchain technology to accelerate your business. We build innovative blockchain development solutions to build innovative applications. Contact us for best blockchain development services." />
...
<link rel="stylesheet" href="assets/owl-carousel/dist/assets/owl.thechme.default.min.css" media="none" onload="if(media!='all')media='all'">
<style>
...
<div class="row hero-banner scrolling-section">
    <picture>
        <source  srcset="assets/img/banner/webp/blockchain.webp" alt="webp">
        <source  srcset="assets/img/banner/jp2/blockchain.jp2" alt="jp2">
        <img src="assets/img/banner/blockchain.jpg" alt="jpg">
    </picture>
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class=" clanpro-bold fz-70 lh-80 color-white pd-0-55">Blockchain Development Solutions & Services</h3>
    ...
    <div class="hero-banner-box">
        ...
        <ul class="list list-inline hero-banner-box-list">
            ...
            <div class="hero-banner-box-button-container">
                ...
                <a class="hero-banner-box-arrow-button right active" href="../blockchain/cryptocurrency-development.html"><i class="fa fa-angle-right"></i></a>
        </div>
    </div>
...
<div class="row service-overview pd-60-0 relative page-section scrolling-section" id="overview">
    <div class="background-title">
        <h3 class=web-services>Blockchain</h3>
        
    </div>
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center clanpro-bold fz-48">Blockchain Development Company</h1>
    </div>
...
<div class="row services-sample page-section scrolling-section" id="services">
    <div class="col-md-4 service-sample-link pd-30-0 bg-green" style="min-height:586px;">
        ...
        <ul class="list service-sample-list clanpro color-white fz-18">
            <li class="active pd-10-0" data-link="blockchain/cryptocurrency-development.html">Cryptocurrency</li>
    ...
    <div class="col-md-4 service-sample-image desktop-version pd-0-0" style="min-height:586px;">
            <picture>
                    ...
                    <img src="assets/img/services-image/cryptocurrency.png" alt="Cryptocurrency">
                </picture>
    ...
    <div class="col-md-4 service-sample-description pd-0-0 bg-gray" >
        ...
        <a href="blockchain/cryptocurrency-development.html" class="service-title pdb-30 fz-48 clanpro-bold" target="_blank">Cryptocurrency</a>
        ...
        <div class="explore-more-button-container">
                    <a href="../blockchain/cryptocurrency-development.html" class="explore-more-button clanpro color-white" target="_blank">
...
<div class="row wearable-app-solution-container pd-0-0 relative page-section scrolling-section" id="Blockchain-solutions" style="margin-top:24px; margin-bottom:11vh">
                <h1 class="section-title align-left color-green pd-30-0 mobile-version fz-48 clanpro-bold">Blockchain Development Solutions</h1>
...
<switch>
	...
	<g>
         ...
         <div class="wearable-box solution-button  align-center first pd-20-0">
           <!-- svg icon comes here -->
           <object>
           <!--?xml version="1.0" encoding="UTF-8"?-->
<svg class="svg replaced-svg" enable-background="new 0 0 27 48" version="1.1" viewBox="0 0 27 48" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
...
<switch>
    ...
    <div class="col-md-9 pd-30-80 relative">
            ...
            <h1 class="section-title align-left color-green pd-30-0 desktop-version fz-48 clanpro-bold">Blockchain Development Solutions</h1>
            ...
            <div class="col-md-12 pd-45-0">
                <h3 class="wearable-title clanpro-bold solution-title fz-35 relative active">Technology</h3>
        ...
        <img src="../assets/img/blockchain/solution.jpg" style="height:950px;" alt="Digital Transformation">
  ...
  <div class="carousel-inner">
    ...
    <div class="item">
           ...
           <p>I enjoyed working with Acropolis. They are nimble and possess excellent communication skills. They helped us solving many technical problem and shaping our end product. They are responsive and handle support remarkably well. I recommend to use Acropolis to businesses/individuals to outsource their IT requirements.</p>
            ...
            <div class="col-md-12 client-intro">
          <h4 class="client-name green fz-22 lh-40">Jasper McHugh</h4>
    ...
    <div class="item">
           ...
           <p>I have been working with Acropolis on several projects for a long time and find them way ahead than other teams that I have worked in past. I own a digital web studio and have worked with them on different projects with different complexity level, but they continue to deliver amazing work consistently. I am very pleased with our association and will continue to test them with much more complex projects as the need arises.</p>
            ...
            <div class="col-md-12 client-intro">
          <h4 class="client-name green fz-22 lh-40">Gabrielle Shaw</h4>
...
<script type="text/javascript" defer async>
    ...
    responsive:{
        ...
        var service_title=["Cryptocurrency","Apache hive","Apache Mahout","Apache Pig","Apache Thrift","Apache Zookeeper","Apache Kafka","NoSql Database","Apache Spark"];
