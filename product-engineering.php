...
<html>
<head>
<meta property="og:title" content="Product Engineering Services & Solutions | Product Modernization & Development - Acropolis">
<meta property="og:description" content="Acropolis provide product engineering services to build innovative products and render enterprise services by partnering with businesses. Our extended solutions include product modernization, legacy application migration and testing services.">
...
<title>Product Engineering Services & Solutions | Product Modernization & Development - Acropolis</title>
<meta name="description" content="Acropolis provide product engineering services to build innovative products and render enterprise services by partnering with businesses. Our extended solutions include product modernization, legacy application migration and testing services." />
...
<style type="text/css">
    .service-overview-description{
        background-image:url("assets/img/product-engineering/introduction.png");
...
<div class="row hero-banner scrolling-section">
    <picture>
            <source  srcset="assets/img/banner/webp/product-engineering.webp" alt="webp">
            <source  srcset="assets/img/banner/jp2/product-engineering.jp2" alt="jp2">
            <img src="assets/img/banner/product-engineering.jpeg" alt="jpg">
        </picture>
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class=" clanpro-bold fz-70 lh-80 color-white pd-0-55">Product Engineering</h3>
   ...
   <div class="hero-banner-box">
        ...
        <ul class="list list-inline hero-banner-box-list">
            ...
            <div class="hero-banner-box-button-container">
                <a class="hero-banner-box-arrow-button left active" href="enterprise-mobility.html"><i class="fa fa-angle-left"></i></a>
                <a class="hero-banner-box-arrow-button right active" href="quality-assurance.html"><i class="fa fa-angle-right"></i></a>
        </div>
    </div>
...
<div class="row service-overview pd-60-0 relative page-section" id="overview">
    <div class="col-md-12 sub-page-hedaing">
        <h1 class="service-page-title pd-0-60 align-center fz-48 clanpro-bold">Product Engineering Services & Solutions</h1>
    </div>
...
<div class="row our-capabilities pd-60-0 page-section scrolling-section" id="capabilities">
   ...
   <a href="portfolio" class="capabilities-button clanpro color-white">
    ...
    <div class="col-md-9 capabilities-image pd-0-0">
        <img src="assets/img/our-capabilites/product-engineering.jpeg" alt="Product Engineering">
    </div>
</div>
...
<div class="row product-prototype page-section scrolling-section" id="process">
      <div class="col-md-2 mg-190-0">
        <img src="../assets/img/product-engineering/process.jpg" class="desktop-version" style="width:377px;height:744px;">
    
    <div class="bg-green product-prototype-content pdr-20">
        <h3 class="area-of-focus-heading color-white fz-40 clanpro-bold">
            PRODUCT ENGINEERING PROCESS
        </h3>
        <p class=" desktop-version section-description area-of-focus-description color-white pd-10-0 fz-20 lh-30 clanpro pdt-30">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
