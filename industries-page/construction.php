...
<div class="row hero-banner">
    <picture>
  <source  srcset="../assets/img/banner/mobile/construction.jpg"  media="(max-width:900px)" type="image/jpg">
  <source srcset="../assets/img/banner/jp2/construction.jp2" type="image/jp2">
  <source srcset="../assets/img/banner/webp/construction.webp" type="image/webp"> 
  <img src="../assets/img/banner/construction.jpg" alt="Jpg">
    </picture>
    <div class="hero-banner-text-container">
                <div class="hero-banner-title-box pd-30-30">
            <h3 class="color-white clanpro-bold fz-70  pd-0-55">Construction Industry</h3>
...
<div class="row service-overview pd-60-0 relative page-section scrolling-section" id="overview">
    <div class="background-title">
         <h3 class="web-services">Construction</h3>
        
    </div>
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center fz-48 clanpro-bold">IT Solutions for Construction Industry</h1>
    </div>
...
<div class="row services-sample page-section scrolling-section" id="our-services">
    <div class="col-md-4 bg-green service-sample-link relative pd-30-0 pdl-10" style="min-height:586px">
        ...
        <li class="active pd-10-0">Technology Consulting Services</li>
        <li class="pd-10-0">Mobility</li>
        <li class="pd-10-0">Cloud Services</li>
        <li class="pd-10-0">Analytics</li>
        <li class="pd-10-0">IT Support and Managed Services</li>
        <li class="pd-10-0">Internet Of Things</li>
        
        </ul>
        
    </div>
    <div class="col-md-4 service-sample-image desktop-version pd-0-0" style="min-height:586px">
        <img src="../assets/img/services-image/construction.jpg" alt="Construction Services">
    </div>
...
<div class="row wearable-app-solution-container page-section scrolling-section pd-0-0 relative" id="our-solutions">
     <h1 class="section-title wearable-container-mobile-title mobile-version align-left color-green pd-30-0 fz-48 clanpro-bold">Wearable Solution</h1>
...
<switch>
	...
	<g>
        ...
        <img src="../assets/img/solution-image/solution-construction.jpg" alt="Construction Solutions">
        
    </div>
    <div class="col-md-6 col-md-offset-3 pd-30-30 relative pdt-155">
            <h1 class="section-title desktop-version align-left color-green pd-30-0 clanpro-bold fz-48">Wearable Solution</h1>
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        var service_title=["Technology Consulting Services","Mobility","Cloud Services","Analytics","IT Support and Managed Services","Internet Of Things"];
