...
<div class="row hero-banner scrolling-section">
        <picture>
            <source  srcset="assets/img/machine-learning/adeolu-eletu-13086-unsplash.webp " alt="webp">
            <source  srcset="assets/img/machine-learning/adeolu-eletu-13086-unsplash.jp2" alt="jp2">
            <img src="assets/img/machine-learning/adeolu-eletu-13086-unsplash.jpg" alt="jpg">
        </picture>
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class=" clanpro-bold fz-70 lh-80 color-white pd-0-55">Machine Learning</h3>
...
<div class="row service-overview pd-60-0 relative page-section scrolling-section" id="overview">
    <div class="background-title">
        <h3 class="web-services web ">Machine Learning</h3>
        
    </div>
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center fz-48 clanpro-bold">Machine Learning Services</h1>
    </div>
...
<div class="row services-sample page-section scrolling-section" id="services">
    ...
    <div class="col-md-4 service-sample-description pd-0-0 bg-gray relative" style="min-height:586px">
        ...
        <p class="service-description clanpro pd-15-0 fz-16 lh-24">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
