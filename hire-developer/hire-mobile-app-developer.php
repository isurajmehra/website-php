    ...
    <div class="hero-banner-box">
        ...
        <ul class="list list-inline hero-banner-box-list">
            ...
            <div class="hero-banner-box-button-container">
                <a href="../dedicated-development-team.php" class="hero-banner-box-arrow-button left active "><i class="fa fa-angle-left"></i></a>
                <a class="hero-banner-box-arrow-button right active" href="../hire-developer/hire-web-developer.php"><i class="fa fa-angle-right"></i></a>
        </div>
    </div>
...
<div class="row pd-0-0 bg-gray pd-30-0 page-section scrolling-section" id="hire-services">
    <div class="col-md-12 pd-60-10 align-center">
        <div class="col-md-3">
            <a href="mobile-app-developer/hire-iphone-app-developer.php" target="_blank">
        ...
        <div class="col-md-3">
            <a href="mobile-app-developer/hire-ipad-app-developer.php" target="_blank">
            <div class="col-md-12 pd-40-0 bg-white hospitality-it-solution-box">
                <img class="mgb-50" src="../assets/icons/travel-and-hospitality/one.svg" alt="retail">
        ...
        <div class="col-md-3">
            <a href="mobile-app-developer/hire-android-developer.php" target="_blank">
           <div class="col-md-12 pd-40-0 bg-white hospitality-it-solution-box">
                <img class="mgb-50" src="../assets/icons/travel-and-hospitality/one.svg" alt="retail">
        ...
        <div class="col-md-3">
            <a href="mobile-app-developer/hire-window-app-developer.php" target="_blank">
           <div class="col-md-12 pd-40-0 bg-white hospitality-it-solution-box">
                <img class="mgb-50" src="../assets/icons/travel-and-hospitality/one.svg" alt="retail">
          ...
          <div class="col-md-3">
            <a href="mobile-app-developer/hire-cross-platform-app-developer.php" target="_blank">
           <div class="col-md-12 pd-40-0 bg-white hospitality-it-solution-box">
                <img class="mgb-50" src="../assets/icons/travel-and-hospitality/one.svg" alt="retail">
           ...
           <div class="col-md-3">
            <a href="mobile-app-developer/hire-swift-developer.php" target="_blank">
            <div class="col-md-12 pd-40-0 bg-white hospitality-it-solution-box">
                <img class="mgb-50" src="../assets/icons/travel-and-hospitality/one.svg" alt="retail">
