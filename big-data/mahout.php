...
<title>Acropolis | Apache Mahout Implementation Services</title>
...
<div class="row hero-banner scrolling-section" style="background-image:url(../assets/img/banner/php.jpg);">
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class=" clanpro-bold fz-70 color-white pd-0-55">Apache Mahout Services</h3>
   ...
   <div class="hero-banner-box">
        ...
        <ul class="list list-inline hero-banner-box-list">
            ...
            <div class="hero-banner-box-button-container">
                <a href="hive.html" class="hero-banner-box-arrow-button active left "><i class="fa fa-angle-left"></i></a>
                <a class="hero-banner-box-arrow-button right active" href="pig.html"><i class="fa fa-angle-right"></i></a>
        </div>
    </div>
...
<div class="row overview-container page-section scrolling-section" id="overview">
    <div class="application-services-container">
        <h3 class="clanpro-bold fz-48 mgb-80 lh-58">Apache Mahout Development</h3>
    ...
    <div class=" programming-services-container">
        <h5 class="clanpro-bold fz-30 mgb-30" style="line-height:40px;">Apache Mahout Implementation Services
        </h5>
