...
<title>Acropolis | Apache Pig Solution</title>
...
<div class="row hero-banner scrolling-section" style="background-image:url(../assets/img/banner/php.jpg);">
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class=" clanpro-bold fz-70 color-white pd-0-55">Apache Pig Solution</h3>
  ...
  <div class="hero-banner-box">
        ...
        <ul class="list list-inline hero-banner-box-list">
            ...
            <div class="hero-banner-box-button-container">
                <a href="mahout.html" class="hero-banner-box-arrow-button left active "><i class="fa fa-angle-left"></i></a>
                <a class="hero-banner-box-arrow-button right active" href="thrift.html"><i class="fa fa-angle-right"></i></a>
        </div>
    </div>
...
<div class="row overview-container page-section scrolling-section" id="overview">
    <div class="application-services-container">
        <h3 class="clanpro-bold fz-48 mgb-80" style="line-height:58px;">Apache Pig Development</h3>
    ...
    <div class=" programming-services-container">
        <h5 class="clanpro-bold fz-30 mgb-30" style="line-height:40px;">Apache Pig Services
        </h5>
        <p class="clanpro fz-21" style="line-height:30px;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
