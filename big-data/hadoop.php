    ...
    <div class="hero-banner-box">
        ...
        <ul class="list list-inline hero-banner-box-list">
            ...
            <div class="hero-banner-box-button-container">
                <a href="../big-data.html" class="hero-banner-box-arrow-button active left "><i class="fa fa-angle-left"></i></a>
                <a class="hero-banner-box-arrow-button right active" href="hive.html"><i class="fa fa-angle-right"></i></a>
        </div>
    </div>
...
<div class="row start-project-container">
    <div class="col-md-12 start-project-blue-background pd-0-0">
                <div class="col-md-7 col-md-offset-1 col-xs-12 start-project-heading pd-90-0">
            <h3 class="fz-38 color-white clanpro-bold">Do you have an interesting project? Let's talk about that!</h3>
            
        </div>
            <a href="../company-page/inquire-now.html" target="_blank"><button type="button" class="start-project-button">DISCUSS</button></a>
