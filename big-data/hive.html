...
<meta property="og:type" content="website" /><meta http-equiv="Content-Type" content="text/html; charset=shift_jis">
<title>Acropolis | Apache Hive Services</title>
...
<div class="row hero-banner scrolling-section" style="background-image:url(../assets/img/banner/php.jpg);">
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class=" clanpro-bold fz-70 color-white pd-0-55">Hive Data Storage
& Retrieval Services</h3>
...
<div class="row service-overview pd-60-0 relative page-section scrolling-section" id="overview">
    <div class="background-title">
        <h3 class="web-services">Apache Hive</h3>
        
    </div>
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center clanpro-bold fz-48">Hive Solutions Integration</h1>
    </div>
...
<div class="row page-section relative pd-85-0 scrolling-section" id="client-speaks" style="min-height:550px;">
    ...
    <div class="col-md-6 pd-120-120 relative" style="z-index:2;">
        <h3 class="clanpro" style="font-size:48px;">Client</h3>
        <h5 class="clanpro-bold green" style="font-size:48px;" >Speaks</h5>
  ...
  <div class="carousel-inner">
    <div class="item active">
          ...
          <h4 class="client-name green">Emily Ruyle</h4>
    ...
    <div class="item">
           ...
           <p>I enjoyed working with Acropolis. They are nimble and possess excellent communication skills. They helped us solving many technical problem and shaping our end product. They are responsive and handle support remarkably well. I recommend to use Acropolis to businesses/individuals to outsource their IT requirements.</p>
            ...
            <div class="col-md-12 client-intro">
          <h4 class="client-name green">Jasper McHugh</h4>
    ...
    <div class="item">
           ...
           <p>I have been working with Acropolis on several projects for a long time and find them way ahead than other teams that I have worked in past. I own a digital web studio and have worked with them on different projects with different complexity level, but they continue to deliver amazing work consistently. I am very pleased with our association and will continue to test them with much more complex projects as the need arises.</p>
            ...
            <div class="col-md-12 client-intro">
          <h4 class="client-name green">Gabrielle Shaw</h4>
...
<switch>
	...
	<g>
		<path d="m37 28.069c0 2.46-2.004 4.464-4.466 4.464-2.463 0-4.466-2.004-4.466-4.464 0-2.462 2.003-4.466 4.466-4.466 0.312 0 0.615 0.031 0.91 0.094 0.238-1.082 0.365-2.183 0.365-3.285 0-5.355-2.728-10.23-7.297-13.044-0.299-0.184-0.394-0.578-0.208-0.877 0.185-0.298 0.576-0.394 0.879-0.208 4.947 3.046 7.901 8.329 7.901 14.13 0 1.253-0.152 2.501-0.435 3.727 1.4 0.753 2.351 2.232 2.351 3.929zm-4.466-3.19c-1.759 0-3.19 1.431-3.19 3.19 0 1.758 1.432 3.188 3.19 3.188 1.76 0 3.189-1.431 3.189-3.188 1e-3 -1.759-1.429-3.19-3.189-3.19zm-7.696 10.86c-2.014 0.837-4.147 1.261-6.338 1.261-4.469 0-8.766-1.828-11.878-5.024-0.64 0.355-1.374 0.558-2.157 0.558-2.463-1e-3 -4.465-2.005-4.465-4.465 0-2.462 2.003-4.466 4.465-4.466 2.463 0 4.466 2.004 4.466 4.466 0 1.217-0.492 2.322-1.287 3.131 2.864 2.881 6.782 4.522 10.855 4.522 2.023 0 3.992-0.391 5.851-1.16 0.325-0.133 0.697 0.021 0.833 0.346 0.135 0.325-0.02 0.699-0.345 0.831zm-17.183-7.67c0-1.76-1.431-3.19-3.19-3.19-1.76 0-3.189 1.431-3.189 3.19 0 1.758 1.43 3.188 3.189 3.188 1.759 1e-3 3.19-1.43 3.19-3.188zm10.845-19.139c-2.025 0-3.737-1.355-4.281-3.206-6.147 1.783-10.533 7.16-10.987 13.596-0.023 0.338-0.303 0.593-0.636 0.593-0.014 0-0.03 0-0.044-3e-3 -0.352-0.023-0.616-0.328-0.592-0.679 0.496-7.034 5.325-12.901 12.074-14.781 9e-3 -2.454 2.009-4.45 4.466-4.45 2.462 0 4.465 2.003 4.465 4.466s-2.003 4.464-4.465 4.464zm0-7.653c-1.758 0-3.19 1.431-3.19 3.188 0 1.759 1.432 3.189 3.19 3.189s3.189-1.43 3.189-3.189c-1e-3 -1.757-1.431-3.188-3.189-3.188z"></path>
            ...
            <h4 class="related-service-title">Apache Hadoop Development</h4>
            </div>
            </a>
