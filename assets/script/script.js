...
},function()
{
  ...
  return "";
   ...
   exdate.setDate(exdate.getDate() + exdays);
	       ...
	       $(".cookies-banner-container").hide();
	       document.cookie="status=allow; path=/;"+"expires="+exdate.toUTCString()+";";
	   });
    ...
    },function()
    {
        ...
        /* make a function which return the page section based on user current position */
        function check_section(current_position)
        {
         if(current_position > position_of_list_start[0] && current_position <= (position_of_list_start[0]+position_of_list_end[0]-150))
            {
            console.log("First Section");
                $(".scrolling-list li").removeClass("active");
                $($(".scrolling-list li").get(0)).addClass("active");
            }
         if(current_position > position_of_list_start[1] && current_position <= (position_of_list_start[1]+position_of_list_end[1]-150))
            {
            console.log("Second Section");
                   $(".scrolling-list li").removeClass("active");
                $($(".scrolling-list li").get(1)).addClass("active");
            }
                       if(current_position > position_of_list_start[2] && current_position <= (position_of_list_start[2]+position_of_list_end[2]-150))
            {
            console.log("Third Section");
                   $(".scrolling-list li").removeClass("active");
                $($(".scrolling-list li").get(2)).addClass("active");
            }
 if(current_position > position_of_list_start[3] && current_position <= (position_of_list_start[3]+position_of_list_end[3]-150))
            {
            console.log("Fourth Section");
                   $(".scrolling-list li").removeClass("active");
                $($(".scrolling-list li").get(3)).addClass("active");
            }
             if(current_position > position_of_list_start[4] && current_position <= (position_of_list_start[4]+position_of_list_end[4]-150))
            {
            console.log("Fifth Section");
                   $(".scrolling-list li").removeClass("active");
                $($(".scrolling-list li").get(4)).addClass("active");
            }
             if(current_position > position_of_list_start[5] && current_position <= (position_of_list_start[5]+position_of_list_end[5]-150))
            {
            console.log("Six Section");
                   $(".scrolling-list li").removeClass("active");
                $($(".scrolling-list li").get(5)).addClass("active");
            }
            if(current_position > position_of_list_start[6] && current_position <= (position_of_list_start[6]+position_of_list_end[6]-150))
            {
            console.log("seventh Section");
                   $(".scrolling-list li").removeClass("active");
                $($(".scrolling-list li").get(6)).addClass("active");
            }
        }
	    var position_of_list_start=[];
        var position_of_list_end=[];
	    
	          var list_of_section=$("body").find(".page-section");
    console.log(list_of_section);
    for(let i=0;i<list_of_section.length;i++)
    {
        //console.log(i+1,$(list_of_section[i]).offset().top);
        let current_list_start_position=$(list_of_section[i]).offset().top;
        position_of_list_start.push(current_list_start_position);
        let current_list_end_position=parseFloat($(list_of_section[i]).outerHeight(true));
        position_of_list_end.push(current_list_end_position);
        ...
        for(let i=0;i<position_of_list_start.length;i++)
            {
                console.log("Start Of: "+i+1,position_of_list_start[i]);
            }
        for(let i=0;i<position_of_list_end.length;i++)
        for(let i=0;i<position_of_list_end.length;i++)
            {
                console.log("End At: "+i+1,position_of_list_end[i]);
            }
...
},function()
{
        ...
        {
            //console.log("Current Poition Is: "+$(this).scrollTop());
            check_section(parseFloat($(this).scrollTop()));
        ...
        $(document).click(function(e){
            var dropdown_content_services=document.getElementsByClassName("dropdown-content-services");
            let target=e.target;
            if(target === dropdown_content_services)
                {
                    console.log("target matched");
                     $(".dropdown-content-services").show();
                }
            else{
                console.log("target not matched");
                   $(".dropdown-content-services").hide();
        ...
        $(".dropdown-content-services").on("click",function(e)
                                          {
            e.stopPropagation();
        })
		$(".dropdown").on("click",function(e)
		{
            e.stopPropagation(); 
            e.preventDefault()
                let dropdown=$($(this).find(".dropdown-content-services")).css("display");
            if(dropdown == "none")
                {
                    $(".dropdown").removeClass("active");
                    ...
                    showMenu($(this).find(".dropdown-content-services"));
                    $(this).addClass("active");
            ...
            else
                {
                    ...
                    hideMenu($(this).find(".dropdown-content-services"));
                }
		});
