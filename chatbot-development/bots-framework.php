...
<title>Bot Framework Development</title>
...
<div class="row hero-banner" style="background-image:url(../assets/img/banner/manufacturing.jpg);">
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class="color-white clanpro-bold fz-70 lh-80 pd-0-55">Bot Framework Development Company</h3>
...
<div class="row service-overview pd-60-0 relative page-section scrolling-section" id="overview">
    <div class="background-title">
        <h3 class="web-services" style="font-size:10.6em;">Bot Framework</h3>
        
    </div>
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center clanpro-bold fz-48">Bot Framework Development Services</h1>
    </div>
...
<div class="row domain-expertise pd-90-0 page-section scrolling-section mgt-50" id="domain-expertise">
