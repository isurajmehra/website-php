...
<title>Bot Development Solution</title>
...
<div class="row hero-banner" style="background-image:url(../assets/img/banner/manufacturing.jpg);">
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class="color-white clanpro-bold fz-70 lh-80 pd-0-55">Bot Development Solutions</h3>
...
<div class="row service-overview pd-60-0 relative page-section scrolling-section" id="overview">
    <div class="background-title">
        <h3 class="web-services" style="font-size:12.6em;">Bot Solution</h3>
        
    </div>
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center clanpro-bold fz-48">Bot Development Company</h1>
    </div>
...
<div class="row wearable-app-solution-container page-section scrolling-section pd-0-0 relative" id="our-solutions">
               <h1 class="section-title align-left color-green pd-30-0 mobile-version fz-48 clanpro-bold">Our Solutions</h1>
...
<switch>
    ...
    <div class="col-md-9 pd-30-80 relative">
            <h1 class="section-title align-left color-green pd-30-0 desktop-version fz-48 clanpro-bold">Our Solutions</h1>
        ...
        <img src="../assets/img/quality-assurance/quality-assurance.jpg" style="height:950px;" alt="Quality Assurance">
 ...
 <!-- opening of area focus -->
   <div class="row area-of-focus pd-60-0 page-section scrolling-section flex" id="key-differentiators">
    ...
    <div class="col-md-3 area-of-focus-text bg-green">
        <h3 class="section-title area-of-focus-heading color-white fz-48 lh-60 clanpro-bold">
         key Differentiators
        </h3>
...
<div class="row domain-expertise pd-90-0 page-section scrolling-section" id="domain-expertise">
    <div class="col-md-12 pd-0-0 domain-expertise-heading relative">
    <h1 class="section-title align-center pd-30-0 clanpro-bold fz-48">Chatbots For Major Channels</h1>
    </div>
    <div class=" col-md-12 domain-expertise-list align-center pd-30-0 owl-carousel domain">
...
<!--here is start domain expertise-->
