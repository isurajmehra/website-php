...
<title>DevOps Solutions & Services Company|Acropolis</title>
...
<div class="row hero-banner scrolling-section" style="background-image:url(../assets/img/banner/cloud.png);">
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class=" clanpro-bold fz-60 color-white pd-0-55">Devops<br>Solutions &<br>Services<br>Company</h3>
   ...
   <div class="hero-banner-box">
        ...
        <ul class="list list-inline hero-banner-box-list">
            ...
            <div class="hero-banner-box-button-container">
                <a href="../cloud.html" class="hero-banner-box-arrow-button left active"><i class="fa fa-angle-left"></i></a>
                <a class="hero-banner-box-arrow-button right active" href="cloud-solutions.html"><i class="fa fa-angle-right"></i></a>
        </div>
    </div>
...
<div class="row service-overview pd-60-0 relative page-section scrolling-section" id="overview">
    <div class="background-title">
        <h3 class=web-services>DevOps Solu.</h3>
        
    </div>
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center clanpro-bold fz-48">DevOps Consulting Services</h1>
    </div>
...
<div class="row services-sample page-section scrolling-section bg-green" id="services">
    <div class="col-md-4 service-sample-link pd-30-0" style="min-height:586px;padding-left:10px">
        <h3 class="section-heading color-white clanpro-bold align-left center pdb-30 fz-45" style="padding:15px 80px;">Service Offerings</h3>
        <ul class="list service-sample-list clanpro fz-18 color-white">
            <li class="active pd-10-0">Configuration Management</li>
            <li class="pd-10-0">Continuous Delivery</li>
            <li class="pd-10-0">Continuous Integration</li>
            <li class="pd-10-0">DevOps on AWS</li>
            <li class="pd-10-0">Monitoring & Logging</li>
        </ul>
    </div>
...
$('.owl-carousel.insights').owlCarousel({
    ...
    nav:true,
     responsive:{
        ...
        var service_title=["Configuration Management","Continuous Delivery","Continuous Integration","DevOps on AWS","Monitoring & Logging"];
