...
.wearable-solution-box-container li{
    width:140px;
}

.wearable-solution-box-container li a{
color:#1fbba6;
}

.wearable-solution-box-container li:hover{
    background-color:#fff;
}
.wearable-solution-box-container li a:hover{
    background-color:#1FBBA6;
    color:#fff;
}
.wearable-solution-box-container>li.active>a, .wearable-solution-box-container>li.active>a:focus, .wearable-solution-box-container>li.active>a:hover{
    background-color:#1FBBA6;
    color:#fff;
}
 .wearable-box img{
...
.wearable-box:hover svg path{
         fill:#fff;
     }
     
     .wearable-box svg path{
         fill:#1FBBA6;
     }
    ...
    .healthcare-component-title::after{
        ...
        .area-of-focus object svg{
            width:50px;
        }
        .area-of-focus .focus-section:hover svg path{
            fill:#1FBBA6;
        }
        .area-of-focus .focus-section .icon-title{
            font-size:20px;
            
        }
        .area-of-focus .focus-section:hover .icon-title{
            color:#1FBBA6;
        }
...
<div class="row hero-banner" style="background-image:url(../assets/img/banner/manufacturing.jpg);">
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class="color-white clanpro-bold fz-60 pd-0-55">Virtual Reality App Development</h3>
     ...
     <div class="hero-banner-box">
        ...
        <ul class="list list-inline hero-banner-box-list">
            ...
            <div class="hero-banner-box-button-container">
                <a href="augmented-reality.php" class="hero-banner-box-arrow-button left active"><i class="fa fa-angle-left active"></i></a>
...
<div class="row service-overview pd-60-0 relative page-section scrolling-section" id="overview">
    <div class="background-title">
        <h3 class="web-services" style="font-size:12.6em;">VR App Dev.</h3>
        
    </div>
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center clanpro-bold fz-48">Virtual Reality Application</h1>
    </div>
...
<div class="row services-samples page-section scrolling-section" id="services">
    <div class="col-md-4 services-samples-links" style="min-height:663px;">
        <h3 class="section-heading color-white clanpro-bold align-left center fz-42" style="padding:0 42px; padding-top:75px; padding-bottom:40px">VR App Development Services</h3>
        <ul class="list services-samples-lists clanpro color-white fz-18">
            <li class="active pd-10-0" data-link="/web-app-development/php-development.php"><span>VR Intigiration and Deployment</span></li>
            <li class="pd-10-0" data-link="/web-app-development/opensource-development.php" class=""><span>Virtual Product Envirnonment</span></li>
            <li class="pd-10-0" data-link="/web-app-development/ror-development.php" class=""><span>Presentaion and Sales Tools</span></li>
             <li class="pd-10-0" data-link="/web-app-development/ror-development.php" class=""><span>VR Tradeshows and Event Apps</span></li>
              <li class="pd-10-0"
                  ...
                  data-link="/web-app-development/ror-development.php" class=""><span>3D Walkthroughs</span></li>
        </ul>
    ...
    <div class="col-md-4 service-sample-description pd-0-0 bg-gray" style="min-height:663;position:relative;">
        ...
        <a href="/web-app-development/php-development.php" class="service-title pdb-30 clanpro-bold fz-48">VR Intigiration and Deployment</a>
...
<div class="row wearable-app-solution-container page-section scrolling-section pd-0-0 relative" id="applications" style="margin-top:100px;">
    <div class="wearable-solution-box-container" style="top:27%;">
...
<switch>
    ...
    <div class="col-md-9 pd-30-30 relative" style="padding:30px 83px; margin-top:83px;">
        <button type="button" class="more-solution-button">More  <i class="fa fa-plus"></i></button>
            <h1 class="section-title align-left color-green pd-30-0 clanpro-bold fz-48" style="padding-right:135px;">Virtual Reality <br>
Application in Industry</h1>
            <p class="section-paragraph clanpro fz-22" style="color:#333;">Lorem Ipsum is simply dummy text of the printing </p>
            <div class="col-md-12 pd-45-0">
                <h3 class="wearable-title clanpro-bold solution-title active">Healthcare</h3>
                <p class="wearable-description clanpro mg-30-0 pdr-50 solution-description active">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
         
                
                <h3 class="wearable-title clanpro-bold solution-title">Wearable Title Two</h3>
                <p class="wearable-description clanpro mg-30-0 pdr-50 solution-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
             ...
             <h3 class="wearable-title clanpro-bold solution-title">Wearable Title Five</h3>
                <p class="wearable-description clanpro mg-30-0 pdr-50 solution-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
        
        
             <h3 class="wearable-title clanpro-bold solution-title">Wearable Title Six</h3>
                <p class="wearable-description clanpro mg-30-0 pdr-50 solution-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
                
                
                <h3 class="wearable-title clanpro-bold solution-title">Wearable Title Seven</h3>
                <p class="wearable-description clanpro mg-30-0 pdr-50 solution-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
                 
                 
                <h3 class="wearable-title clanpro-bold solution-title">Wearable Title Eight</h3>
                <p class="wearable-description clanpro mg-30-0 pdr-50 solution-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
                
                
                <h3 class="wearable-title clanpro-bold solution-title">Wearable Title Nine</h3>
                <p class="wearable-description clanpro mg-30-0 pdr-50 solution-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
...
<script type="text/javascript">
    ...
    responsive:{
        ...
        var service_title=["VR Integration and deployment","virtual product envirnonment","Presentaion and sales tools","VR Tradeshows and Event App","3D walkthroughs","Location Based AR","NodeJs Development","ExpressJS Development"];
