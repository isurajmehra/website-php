...
<div class="row hero-banner" style="background-image:url(../assets/img/banner/manufacturing.jpg);">
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class="color-white clanpro-bold fz-60 pd-0-55">Augmented Reality App Development</h3>
...
<div class="row service-overview pd-60-0 relative page-section scrolling-section" id="overview">
    <div class="background-title">
        <h3 class="web-services" style="font-size:12.6em;">AR APP DEV.</h3>
        
    </div>
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center clanpro-bold fz-48">Leading AR App Development Company</h1>
    </div>
...
<div class="row wearable-app-solution-container page-section scrolling-section pd-0-0 relative" id="solutions" style="margin-top:100px;">
...
<switch>
    ...
    <div class="col-md-9 pd-30-30 relative" style="padding:30px 83px; margin-top:83px;">
        <button type="button" class="more-solution-button">More  <i class="fa fa-plus"></i></button>
            <h1 class="section-title align-left color-green pd-30-0 clanpro-bold fz-48" style="padding-right:135px;">Augmented Reality 
App Development Solutions</h1>
            ...
            <div class="col-md-12 pd-45-0">
                <h3 class="wearable-title clanpro-bold solution-title active">Navigation</h3>
...
<script type="text/javascript">
    ...
    responsive:{
        ...
        var service_title=["Projection Based AR","Recoginition Based AR","Outlining AR","Superimposition Based AR","Location Based AR","NodeJs Development","ExpressJS Development"];
