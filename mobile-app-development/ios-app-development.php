   ...
   <div class="hero-banner-box">
        ...
        <ul class="list list-inline hero-banner-box-list">
            ...
            <div class="hero-banner-box-button-container">
                <a href="../mobile-app-development.php" class="hero-banner-box-arrow-button left active "><i class="fa fa-angle-left"></i></a>
                <a class="hero-banner-box-arrow-button right active" href="android-app-development.php"><i class="fa fa-angle-right"></i></a>
        </div>
    </div>
