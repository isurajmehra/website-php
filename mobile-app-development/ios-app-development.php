...
<title>iOS App Development Company in USA, India | iOS App Development Services | Acropolis</title>
<meta name="description" content="iOS app development services by top iOS development firm - Acropolis is top iOS application development company in USA, India. iOS App Developers India offer iOS apps development services at low cost." />

<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link rel="shortcut icon" type="image/png" href="../assets/img/fevicon/fevicon.png"/>
    <meta property="og:title" content="iOS App Development Company in USA, India | iOS App Development Services | Acropolis">
<meta property="og:description" content="iOS app development services by top iOS development firm - Acropolis is top iOS application development company in USA, India. iOS App Developers India offer iOS apps development services at low cost.">
    ...
    <div class="scrolling-list-component">
        <div class="scrolling-button-container">
                ...
                <span class="dot-circle three"></span></div>
                    <div class="scrolling-list-container" style="top:-95px">
...
<div class="row hero-banner scrolling-section" style="background-image:url(../assets/img/banner/mobile-app-development.png);">
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class=" clanpro-bold fz-70 lh-80 color-white pd-0-55">iOS App Development Company</h3>
   ...
   <div class="hero-banner-box">
        ...
        <ul class="list list-inline hero-banner-box-list">
            ...
            <div class="hero-banner-box-button-container">
                <a href="../mobile-app-development.html" class="hero-banner-box-arrow-button left active "><i class="fa fa-angle-left"></i></a>
                <a class="hero-banner-box-arrow-button right active" href="android-app-development.html"><i class="fa fa-angle-right"></i></a>
        </div>
    </div>
...
<div class="row service-overview pd-60-0 relative page-section scrolling-section" id="overview">
    ...
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center clanpro-bold fz-48">iOS App Development Services</h1>
    </div>
    <div class="col-md-6 service-overview-stats pd-60">
        <p class="pd-0-60 color-light-green clanpro fz-21 lh-36 ">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        
    </div>
    <div class="col-md-6 service-overview-description pd-60 lh-36">
    ...
    <div class="col-md-12 pd-30-0">
        <p class="pd-0-60 clanpro fz-21 lh-36">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
...
<div class="row services-sample page-section scrolling-section bg-green" id="Services">
    <div class="col-md-4 service-sample-link pd-30-0 pdl-10">
        ...
        <ul class="list service-sample-list clanpro fz-18 color-white">
            <li class="active pd-10-0">iPhone App Development</li>
            <li class="pd-10-0">iPad App Development</li>
        </ul>
    </div>
    ...
    <div class="col-md-4 service-sample-description pd-0-0 bg-gray relative">
        ...
        <a href="#" class="service-title pdb-30 clanpro-bold fz-48">iPhone App Development</a>
...
$('.owl-carousel.insights').owlCarousel({
    ...
    nav:true,
     responsive:{
        ...
        var service_title=["iPhone App Development","iPad App Development"];
