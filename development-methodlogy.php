...
<html>
<head>
<meta property="og:title" content="Implementation of Project Development Methodologies at Acropolis">
<meta property="og:description" content="Acropolis has a very disciplined approach to the methods and strategies used in a project development process. We offer Agile, Scrum, Waterfall, Spiral and Iterative methodologies.">
...
<title>Implementation of Project Development Methodologies at Acropolis</title>
<meta name="description" content="Acropolis has a very disciplined approach to the methods and strategies used in a project development process. We offer Agile, Scrum, Waterfall, Spiral and Iterative methodologies." />
...
.development-box img{
   ...
   max-width:100%;
    text-align:center;
           ...
           .development-box:nth-child(2) img{
   width:50%;
   max-width:100%;
    text-align:center;
     }
...
<div class="row hero-banner half" style="background-image:url(assets/img/banner/development-delivery.jpg);">
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class=" clanpro-bold fz-70 lh-80 color-white pd-0-55">Development Methodology</h3>
...
<div class="row service-overview pd-60-0 relative page-section" id="service-overview">
       <div class="background-title">
        <h3 class="web-services">Discipline</h3>
        
    </div>
    <div class="col-md-12">
        <h1 class="service-page-title pd-0-60 align-center fz-48 clanpro-bold">Standardizing The Method Of Developing a Software, System or Application</h1>
    </div>
...
<div class="row core-values pd-60-0">
    <div class="col-md-5 bg-green color-white pd-30-10 methodlogoy">
       <h3 class="section-title color-white fz-48 clanpro-bold">Methodlogies</h3> 
        <p class="section-description lh-24 clanpro pd-20-0 fz-18">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
    </div>
    <div class="col-md-7 pd-60-60 methodlogy-text">
        <p class="section-description pad-left clanpro fz-20 pdl-83">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
    </div>
    <div class="col-md-12 pd-0-0 development-section">
        <div class="col-md-4 align-center center development-box">
            <h3 class="method-title fz-20 align-center center clanpro-bold pd-30-0">Agile</h3>
            <img src="assets/img/methodlogy/agile.svg" alt="Agile">
            <p class="core-values-explaination text-color-blue clanpro fz-20 mg-20-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
                <div class="col-md-4 align-center center development-box">
                      <h3 class="method-titlealign-centee center fz-20 clanpro-bold pd-30-0">Waterfall</h3>
              <img src="assets/img/methodlogy/waterfall.svg" alt="Waterfall">
            <p class="core-values-explaination text-color-blue clanpro fz-20 mg-20-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
                <div class="col-md-4 align-center center development-box">
                      <h3 class="method-title fz-20  align-center center clanpro-bold pd-30-0">Spiral</h3>
             <img src="assets/img/methodlogy/spiral.svg" alt="Spiral">
            <p class="core-values-explaination text-color-blue clanpro  fz-20 mg-20-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
           
          <div class="col-md-4 align-center center development-box">
                <h3 class="method-title align-center center fz-20 clanpro-bold pd-30-0">Scrum</h3>
            <img src="assets/img/methodlogy/scrum.svg" alt="Agile">
            <p class="core-values-explaination text-color-blue clanpro fz-20 mg-20-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
          <div class="col-md-4 align-center center development-box">
                            <h3 class="method-titlealign-center center fz-20 clanpro-bold pd-30-0">Iterative</h3>
            <img src="assets/img/methodlogy/iterative.svg" alt="Agile">
            <p class="core-values-explaination text-color-blue clanpro fz-20 mg-20-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
    </div>
    
</div>
<!-- opening of development approah -->
<div class="row development-approach align-center">
    <div class="col-md-12 pd-0-0 domain-expertise-heading relative">
        <h1 class="section-title align-center pd-15-0 fz-48 clanpro-bold">Development Approach</h1>
        </div>
    <p class="section-description color-gray fz-24 desktop-version clanpro mg-20-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
    <div class="development">
    <div class="driven-development align-center">
        <h3 class="section-title fz-48 clanpro-bold">Lorem Ipsum is simply</h3>
        <p>Lorem Ipsum is simply</p>
           <img src="assets/img/methodlogy/software-development-life-cycle-one.png" alt="Agile">
...
<!-- closing of development approach -->
<div class="row page-section relative pd-85-0 scrolling-section" id="client-speaks" style="min-height:550px;">
    ...
    <li data-target="#myCarouselClientSpeak" data-slide-to="0" class=""></li>
    <li data-target="#myCarouselClientSpeak" data-slide-to="1" class="active"></li>
