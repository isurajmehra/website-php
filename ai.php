...
<html>
<head>
<meta property="og:title" content="Artificial Intelligence Solutions Programming & Consulting | Acropolis">
<meta property="og:description" content="Acropolis offers Artificial Intelligence solutions to clients and helps them in developing a range of applications of AI. Contact us to get best AI software services.">
...
<title>Artificial Intelligence Solutions Programming & Consulting | Acropolis</title>
<meta name="description" content="Acropolis offers Artificial Intelligence solutions to clients and helps them in developing a range of applications of AI. Contact us to get best AI software services." />
...
<link rel="stylesheet" href="assets/owl-carousel/dist/assets/owl.theme.default.min.css" media="none" onload="if(media!='all')media='all'">
    <style type="text/css">
    .animation-text-heading,.animation-text-subheading{
        padding-right: 5px;
...
<div class="row hero-banner scrolling-section">
    <picture>
        <source srcset="assets/img/banner/jp2/ai.jp2" type="image/jp2">
        <source srcset="assets/img/banner/webp/ai.webp" type="image/webp"> 
        <img src="assets/img/banner/ai.jpg" alt="Jpg">
      </picture>
    <div class="hero-banner-text-container">
        <div class="hero-banner-title-box pd-30-30">
            <h3 class=" clanpro-bold fz-70 lh-80 color-white pd-0-55">Artificial Intelligence Solutions</h3>
    ...
    <div class="hero-banner-box">
        ...
        <ul class="list list-inline hero-banner-box-list">
            ...
            <div class="hero-banner-box-button-container">
                ...
                <a class="hero-banner-box-arrow-button right active" href="ai/machine-learning.html"><i class="fa fa-angle-right"></i></a>
        </div>
    </div>
...
<div class="row services-sample page-section scrolling-section" id="services">
    <div class="col-md-4 service-sample-link pd-30-0 bg-green" style="min-height:586px;padding-left:10px">
        <h3 class="section-heading color-white clanpro-bold align-left center pdb-30 fz-45" style="padding:15px 80px;">Our <br> Services</h3>
        <ul class="list service-sample-list clanpro color-white fz-18">
            <li class="active pd-10-0" data-link="../ai/machine-learning.html">Machine Learning</li>
            <li class="pd-10-0" data-link="../ai/chatbot.html">Chatbot</li>
            <li class="pd-10-0" data-link="../ai/alexa-app-development.html">Alexa App Development</li>
            <li class="pd-10-0" data-link="../ai/google-home-services.html">Google Home</li>
             <li class="pd-10-0" data-link="../ai/nlp.html">NLP</li>
             </ul>
    ...
    <div class="col-md-4 service-sample-image desktop-version pd-0-0" style="min-height:586px;">
        <picture>
            ...
            <img src="assets/img/services-image/ai.jpg" alt="Artificial Intelligence">
        </picture>
        
    </div>
    <div class="col-md-4 service-sample-description pd-0-0 bg-gray" style="min-height:586px;position:relative;">
        <div class="col-md-12 relative" >
        <a href="../ai/machine-learning.html" class="service-title pdb-30 fz-48 clanpro-bold" target="_blank">Machine Learning</a>
        ...
        <div class="explore-more-button-container">
                    <a href="../ai/machine-learning.html" class="explore-more-button clanpro color-white" target="_blank">
...
<div class="row stats-section pd-83-0 pdt-0">
    ...
    <div class="col-md-7 bg-green desktop-version pd-30-60">
        ...
        <span class="animation-text-heading"></span>
         </p><p class="what-we-build">That People
         <span class="animation-text-subheading"></span>
         </p>
...
<p class="service-portfolio-description-paragraph clanpro pd-20-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
 ...
 <!-- opening of item -->
  ...
  <p class="service-portfolio-description-paragraph clanpro pd-20-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
    ...
    <div class="item">
    <div class="col-md-6 portfolio-image pd-0-0">
        <img src="assets/img/jet-airways.j2k" alt="Jet Airways">
     </div>
     <div class="col-md-6 pd-0-0  service-portfolio-description align-left pd-60-30 bg-gray">
...
<script type="text/javascript" defer async>
    ...
    responsive:{
        ...
        var service_title=["Machine Learning","Chatbot","Alexa App Development","Google Home","NLP"];
        var service_description=["Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
...
<script type="text/javascript">
    $(document).ready(function()
    {
               var titleList=["Website","App","Software"];
        var subTitleList=["Love","Use","Buy"];
        var characterArray=[],characterIndex=0,wordIndex=0;
         var characterSubTitleArray=[],characterSubTitleIndex=0,wordSubTitleIndex=0;
        var subTitleInterval="",titleInterval="";
        function getCharactersFromWord() 
        {
            characterArray=titleList[wordIndex].split("");
        }
        function getCharactersFromSubHeading()
        {
            characterSubTitleArray=subTitleList[wordSubTitleIndex].split("");
        }
        getCharactersFromWord();//call  the default charatersArray
        getCharactersFromSubHeading()// call the default characterSubHeadingArray
        
        var stopTitleAnimation=function()
        {
         ...
         var stopSubTitleAnimation=function()
        {
            return new Promise((resolve,reject) =>
                              {
         ...
         {
             $(".animation-text-heading").text("");
         }
          var clearSubTitle=function()
         {
             $(".animation-text-subheading").text("");
         }
        var startTextAnimation=function()
        {
            titleInterval=setInterval(() => {
             console.log("Title Block");
            $(".animation-text-heading").append(characterArray[characterIndex]);
            characterIndex++;
                console.log(characterIndex,characterArray.length);
            if(characterIndex > characterArray.length)
                {
                    stopTitleAnimation().then(() => {
                        startSubTitleAnimation()
                    })
                    characterIndex=0;
                    wordIndex++;
                     getCharactersFromWord();
                    console.log(characterArray);
                    
                }
                if(wordIndex >= titleList.length-1)
                    {
                        wordIndex=0;
                    }
        },500);
        }
         var startSubTitleAnimation=function()
        {
        subTitleInterval=setInterval(() => {
            console.log("Sub Title Block");
            $(".animation-text-subheading").append(characterSubTitleArray[characterSubTitleIndex]);
            characterSubTitleIndex++;
            if(characterSubTitleIndex > characterSubTitleArray.length)
                {
                    stopSubTitleAnimation().then(() => 
                                                {
                        startTextAnimation();
                    })
                    characterSubTitleIndex=0;
                    wordSubTitleIndex++;
                    getCharactersFromSubHeading();
                    clearTitle();
                    clearSubTitle();
                }
            if(wordSubTitleIndex >= subTitleList.length-1)
                {
                    wordSubTitleIndex=0;
                }
        },500)
        ...
        startTextAnimation();//call the animation function which animate the titleText
